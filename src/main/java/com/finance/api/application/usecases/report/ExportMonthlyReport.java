...
public class ExportMonthlyReport {
    ...
    public ExportMonthlyReport(TransactionGateway transactionGateway, AccountGateway accountGateway, UserGateway userGateway, ReportGateway reportGateway) {
    ...
    public byte[] execute(String userEmail) {
        ...
        return reportGateway.generateExcel(allTransactions);
    }
}